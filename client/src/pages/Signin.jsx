...
import {signInStart, signInFailure, signInSuccess, initial} from '../redux/user/userSlice'
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <div className='flex gap-2 mt-5'>
        ...
        <Link to="/signup"><span onClick={()=>dispatch(initial())} className='text-blue-700'>Sign up</span></Link>
      </div>
